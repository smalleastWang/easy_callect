...
class _ModuleWidgetState extends State<ModuleWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListWidget(
        filterList: [
          appState.getDictOptionsByValue('GENDER', 'gender'),
          appState.getDictOptionsByValue('BRAND', 'brand'),
          appState.getDictOptionsByValue('BILL_PAYMENTSTATUS', 'billPaymentstatus'),
