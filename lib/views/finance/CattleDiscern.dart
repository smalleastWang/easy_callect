...
///
/// 查勘对比
class CattleDiscernPage extends StatefulWidget {
  const CattleDiscernPage({super.key});

  @override
  State<CattleDiscernPage> createState() => _CattleDiscernPageState();
}

class _CattleDiscernPageState extends State<CattleDiscernPage> {
